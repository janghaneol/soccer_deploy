					...
					<div class="ml-auto">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li class="active"><a href="players" class="nav-link">Players</a></li>
					...
					<div class="col-6 text-right">
						<div class="custom-nav">
							<a href="#" class="js-custom-prev-v2"><span
								class="icon-keyboard_arrow_left"></span></a> <span></span> <a
								href="#" class="js-custom-next-v2"><span
					...
					<div class="item">
						<div class="video-media">
							...
							<a href="https://vimeo.com/139714818"
								class="d-flex play-button align-items-center" data-fancybox>
								<span class="icon mr-3"> <span class="icon-play"></span>
							</span>
								<div class="caption">
					...
					<div class="custom-media d-flex">
						...
						<div class="text">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								Possimus deserunt saepe tempora dolorem.</p>
							<p>
								<a href="#">Read more</a>
							</p>
						</div>
