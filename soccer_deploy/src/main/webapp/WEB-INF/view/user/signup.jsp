	...
	<section class="bg">
                <div class="container py-4">
                    ...
                    <!-- registForm Start -->
                        ...
                        <fieldset>
                            <div>
                                <label for="email" id="id" class="form-label mt-4">이메일</label>
                                <form:input name="email" id="email" type="text" class="form-control" value="${user.email}" 
                                    aria-describedby="emailHelp" path="email" placeholder="이메일 형태로 입력해주세요." oninput="onblur()"/>
                                <button type="button" onclick="checkId()">중복확인</button>
                            	<span class="id_ok">사용 가능한 이메일입니다.</span>
								<span class="id_already">중복된 이메일입니다.</span>
                            </div>
